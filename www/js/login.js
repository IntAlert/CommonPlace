(function (jQuery, Firebase, Path) {
    ...
    var rootRef = new Firebase("https://commonplaceapp.firebaseio.com");
...
ref.createUser({
  ...
  if (error) {
    ...
    console.log("Successfully created user account with uid:", userData.uemail);
  }
